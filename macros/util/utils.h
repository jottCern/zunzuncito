// $Id: utils.h,v 1.18 2012/03/08 20:31:14 mschrode Exp $
...
namespace util {
  ...
  //! Replace incompatible characters (e.g. ()/# ) by"_"
  //! 
  // -------------------------------------------------------------------------------------
  static inline TString cleanString(const TString &name) {
    TString Name = name;
    Name.ReplaceAll("(","_");
    Name.ReplaceAll(")","_");
    Name.ReplaceAll("/","_");
  ...
  //! 
  // -------------------------------------------------------------------------------------
  static inline TString cleanStringMore(const TString &name) {
    TString Name = cleanString(name);
    Name.ReplaceAll("{","_");
    Name.ReplaceAll("}","_");
    Name.ReplaceAll("^","_");
    Name.ReplaceAll(".","_");
