// $Id: FileOps.h,v 1.16 2012/05/31 20:16:31 mschrode Exp $
...
namespace util
{
  ...
  public:
    ...
    static TGraphErrors* readTGraphErrors(const TString &fileName, const TString &gName, const TString &newGName = "");
  ...
  // -------------------------------------------------------------------------------------
  TGraphErrors* FileOps::readTGraphErrors(const TString &fileName, const TString &gName, const TString &newGName) {
    TFile file(fileName,"READ");
    TGraphErrors *g = 0;
    file.GetObject(gName,g);
    if( g ) {
